...
public class Runes extends ClickCompare
{
	...
	{
		return (event.getOpcode() == MenuAction.GAME_OBJECT_FIRST_OPTION.getId() && event.getTarget().equals(rune)) ||
			(event.getOpcode() == MenuAction.GAME_OBJECT_FIRST_OPTION.getId() && event.getTarget().equals("<col=ff9040>Magic Imbue<col=ffffff> -> <col=ffff>Yourself"));
	}
