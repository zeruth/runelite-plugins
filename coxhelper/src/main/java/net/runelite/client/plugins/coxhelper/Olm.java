...
public class Olm
{
	...
	private void headAnimations()
	{
		...
		OlmAnimation currentAnimation = OlmAnimation.fromId(((DynamicObject) this.head.getRenderable()).getAnimationID());
	...
	private void handAnimations()
	{
		...
		OlmAnimation currentAnimation = OlmAnimation.fromId(((DynamicObject) this.hand.getRenderable()).getAnimationID());
